defmodule NervesSystemHlk7628n.MixProject do
  use Mix.Project

  @github_organization "yuchangyuan"
  @app :nerves_system_hlk7628n
  ...
  defp deps do
    [
      ...
      {:nerves_toolchain_mipsel_nerves_linux_musl, "~> 1.5.0", runtime: false},
